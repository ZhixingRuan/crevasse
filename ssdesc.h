...
namespace ssdesc
{
	...
	template<class fnumtype> void calc_ssdescs_alt(const fnumtype* image, const int image_width,
		...
		vector<fnumtype>* resp, vector<coordElem>* draw_coords, vector<coordElem>* salient_coords,vector<coordElem>* homogeneous_coords, vector<coordElem>* snn_coords, const rectRegion calc_rect = rectRegion());
